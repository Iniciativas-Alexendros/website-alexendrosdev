    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            "w-full bg-inset border border-border-subtle rounded-md px-3.5 py-2.5 text-foreground placeholder:text-muted transition-all duration-fast resize-y min-h-[100px]",
